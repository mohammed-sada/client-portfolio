  ...
  return (
    ...
    <br/>
      ...
      <ul>
        ...
        <li>
          Developed and maintained Python packages for data ingestion, cleaning,
          and standardization
        </li>
        <li>
          Guided data science team in best practices for Python development and
          software testing
        </li>
        <li>
      ...
      <h4 id="distil-networks-remote-data-scientist-oct-2015-nov-2017">
        <a href="http://www.distilnetworks.com/" rel="noreferrer" target="_blank">
          ION GX Technology
        </a>{" "}
      ...
      <ul>
        <li>
          Researched and developed machine learning techniques for detection of
          malicious web bots
        </li>
        <li>
          Lead research for validation of JavaScript-based client fingerprinting
          technique
        </li>
        <li>
          Constructed hierarchical Bayesian models for analysis of internet user
          behavior
        </li>
        <li>
      ...
      <h2 className="heading2" id="education">Education</h2>
      <dl>
        <dt>2005-2009</dt>
        <dd>
          <p>
      ...
      <h2 className="heading2" id="technical-experience">Technical Experience</h2>
      <dl>
        ...
        <dd>
          ...
          <ul>
            <li>
              <strong>Programming Languages (high proficiency):</strong> Python
            </li>
            <li>
            ...
            <li>
              <strong>Data Stores:</strong> Postgres, Elasticsearch, Cassandra,
              MongoDB, Redis, MySQL
            </li>
          </ul>
        </dd>
        ...
        <dd>
          ...
          <p>
            ...
            ·{" "}
            <a href="https://datamicroscopes.github.io/" rel="noreferrer" target="_blank">
              datamicroscopes
            </a>{" "}
            ·{" "}
            <a
      ...
      <h2 className="heading2" id="personal-projects">Personal Projects</h2>
      <ul>
        <li>
